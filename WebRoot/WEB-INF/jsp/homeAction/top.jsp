...
<head>
	...
	<script type="text/javascript">
		function check(){
			if(!confirm("是否退出系统！")){
				document.getElementById("logout").href="${pageContext.request.contextPath}/home_index.action";
			}
		}
	</script>
	<style type="text/css">
...
<body CLASS=PageBody leftmargin=0 topmargin=0 marginwidth=0 marginheight=0>
	...
	<div id="Head1">
		<div id="Logo">
			...
			<%--人事管理系统--%>
            <font color="#0000CC" style="color:#F1F9FE; font-size:30px; font-family:Arial Black, Arial">&nbsp;&nbsp;人事管理系统&nbsp;</font> 
		...
		<div id="Head1Right">
			...
			<div id="Head1Right_UserSetup" style="display: none;">
        ...
        <div id="Head1Right_SystemButton">
            <a href="${pageContext.request.contextPath}/user_logout.action" target="_parent" onclick="check();" id="logout">
    ...
    <div id="Head2">
        <div id="Head2_Awoke">
            <ul id="AwokeNum">
                <li><a href="javascript:void(0)" target="right"><img border="0" width="11" height="13" src="${pageContext.request.contextPath}/style/images/top/msg.gif" /> 消息<span id="msg"></span></a></li>
                <li class="Line"></li>
                <li><a href="javascript:void(0)" target="right"<img border="0" width="16" height="11" src="${pageContext.request.contextPath}/style/images/top/mail.gif" /> 邮件<span id="mail"></span></a></li>
                <li class="Line"></li>
