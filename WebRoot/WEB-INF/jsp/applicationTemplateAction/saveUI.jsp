			...
			<div class="ItemBlockBorder">
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							<td>所用流程</td>
							<td><s:select list="processDefinitionList"
									cssClass="SelectStyle" name="processDefinitionKey"
					...
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td><input type="file" name="upLoad"
								class="InputStyle {required:true,accept:'doc|docx'}"
								style="width:450px;" value="${path}"/></td>
						</tr>
					</table>
				</div>
			</div>
