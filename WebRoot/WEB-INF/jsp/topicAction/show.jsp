			...
			<table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
				<tr height="30" class="Tint">
					...
					<td class="no_color_bg">
						<s:textfield name="title" cssClass="InputStyle" cssStyle="width:100%" value="回复：%{#topic.title}" readonly="readonly"/>
						<%--<input type="text" name="title" class="InputStyle" value="回复：${topic.title}" style="width:90%" readonly="readonly"/>
					--%></td>
				</tr>
